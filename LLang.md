...
Допускается писать скобки для правильного расставления приоритетов, не допускается писать пробелы (кроме мест между аргументами функции), символы табуляции и/или переносы строки внутри выражения.
